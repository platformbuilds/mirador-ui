          ...
          <ul className="space-y-2">
            ...
            <li>
              <a 
                href="#/incident" 
                className={`flex items-center ${sidebarCollapsed ? 'justify-center px-2' : 'gap-3 px-3'} py-2 rounded-lg font-body text-sm transition-all duration-200 ${
                  route.startsWith("/incident") ? "bg-impact-primary text-white" : "hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300"
                }`}
                title={sidebarCollapsed ? "Incident" : ""}
              >
                <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
